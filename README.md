...
| 日期 | 版本 | 更新内容 |
|------|------|----------|
| 2026-03-11 | `2026.3.8` | <ul><li>升级 OpenClaw 到 `2026.3.8`，并调整镜像环境与飞书官方插件预更新流程</li><li>新增 `PRIMARY_MODEL`，增强图片模型与多 Provider 配置能力</li><li>QQ 机器人新增 `QQBOT_BOTS_JSON` 多 Bot 配置支持</li><li>企业微信重构为账号中心配置，补充默认账号、命令、动态 Agent 等能力，并兼容旧版环境变量</li><li>飞书新增多账号配置、默认账号与群组策略能力，配置逻辑对齐企业微信</li><li>重构配置同步逻辑，完善 QQ / WeCom / Feishu 多账号处理与插件启停联动</li><li>补充飞书官方插件安装说明及异常处理指引</li></ul> |
